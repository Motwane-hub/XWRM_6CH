...
#Region "Public Function and Subroutines"
    ...
    Public Sub SetParameters(ByVal objTestmode As enmTestMode, ByVal vectorGroup As String, ByVal vectorGroupYNYN As Integer, ByVal windingSelection As Double, ByVal winding As Double, ByVal intHVCurrent As Double, ByVal intLVCurrent As Double, ByVal intHrTime As Integer, ByVal intTotalTap As Integer, ByVal intCurrentTap As Integer, ByVal objHVRange As enmRange, ByVal objLVRange As enmRange, ByVal testObject As String, ByVal DUTSpecification As String, ByVal DUTSerialNumber As String, ByVal DUTMake As String, ByVal DUTTestLocation As String, ByVal year As String)
        Try
            ...
            'HVSelection
            'Select Case intHVSelection
            '    Case enmHVSelection.SELECTED
            '        strCommand = strCommand & "#01"

            '    Case enmHVSelection.Not_SELECTED
            '        strCommand = strCommand & "#00"
            ...
            'LVSelection
            'Select Case intLVSelection
            '    Case enmLVSelection.SELECTED
            '        strCommand = strCommand & "#01"

            '    Case enmLVSelection.Not_SELECTED
            '        strCommand = strCommand & "#00"
            ...
            'If testObject.Length > 21 Then
            '    testObject = testObject.Substring(0, 21)
            'End If

            'For Each strChar As Char In testObject
            '    strDUTTestObject = strDUTTestObject & "#" & ConvertCharToHex(strChar).PadLeft(2, "0")
            'Next
            ...
            'Do While strDUTTestObject.Length < 21
            '    strDUTTestObject = strDUTTestObject & "#00"
            'Loop


            'strCommand = strCommand & strDUTTestObject
            ...
            'If DUTType.Length > 21 Then
            '    DUTType = DUTType.Substring(0, 21)
            'End If
            ...
            'If DUTSerialNumber.Length > 21 Then
            '    DUTSerialNumber = DUTSerialNumber.Substring(0, 21)
            'End If
            ...
            'Do While strDUTSerialNumber.Length < 21
            ...
            'If DUTTestLocation.Length > 21 Then
            '    DUTTestLocation = DUTTestLocation.Substring(0, 21)
            'End If
            ...
            'Do While strDUTTestLocation.Length < 21
            ...
            'If year.Length > 8 Then
            '    year = year.Substring(0, 8)
            'End If

            'For Each strChar As Char In year
            '    strYear = strYear & "#" & ConvertCharToHex(strChar).PadLeft(2, "0")
            'Next
            ...
            'Do While strYear.Length < 8
            '    strYear = strYear & "#00"
            'Loop

            'strCommand = strCommand & strYear

            ' DUT YEAR
            Dim strYear As String = vbNullString

            ' 1) Truncate input to max 8 chars
            ...
            ' 3) Pad the remaining bytes with "#00" until total = 8 bytes
            ...
            strCommandFrame(103) = CalculateCRC(strCommandFrame)
                ...
                Case 49 'Normal
                    ...
                    Select Case btData(3)
                        ...
                        Case 208 'Normal Response
                            ...
                            'LV Current Unit
                            'strBinary = ToBinary(CDec("&h" & Hex(btData(13)).PadLeft(2, "0")))
                            ...
                            '       ' _ResponseResult.TestCurrent = _ResponseResult.TestCurrent '* 1000
                            '    Case "0001"
                            '        '_ResponseResult.CurrentUnit = enmCurrentsUnit.Ampere
                            '        _ResponseResult.LVTestCurrentUnit = enmCurrentsUnit.Ampere
                            'End Select

                            'Select Case _ResponseResult.LVTestCurrent
                            '    Case Is < 1
                            '        _ResponseResult.LVTestCurrent = Math.Round(_ResponseResult.LVTestCurrent, 4)
                            '    Case Is < 10
                            '        _ResponseResult.LVTestCurrent = Math.Round(_ResponseResult.LVTestCurrent, 3)
                            '    Case Is < 100
                            '        _ResponseResult.LVTestCurrent = Math.Round(_ResponseResult.LVTestCurrent, 2)
                            '    Case Is < 1000
                            '        _ResponseResult.LVTestCurrent = Math.Round(_ResponseResult.LVTestCurrent, 1)
                            '    Case Is < 10000
                            '        _ResponseResult.LVTestCurrent = Math.Round(_ResponseResult.LVTestCurrent, 0)
                            'End Select
                            ...
                            'strBinary = ToBinary(CDec("&h" & Hex(btData(18)).PadLeft(2, "0")))
                            ...
                            'strBinary = ToBinary(CDec("&h" & Hex(btData(23)).PadLeft(2, "0")))
